...
///
///  Copyright (C) 2014-2016 Simba Technologies Incorporated.
//==================================================================================================
...
namespace Quickstart
{
    ...
    public:
        ...
        /// @param in_isNewDsn              Flag indicating if this is a new DSN or not to load
        ///                                 attributes for.
        void Load(const simba_wstring& in_attributeString, bool in_isNewDsn = false);
